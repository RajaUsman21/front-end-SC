    ...
    return (
        <>
            ...
            <div
                ...
                <img className="rounded-t-lg w-96 h-64" src="http://www.w3.org/2000/svg" alt="" />
                <div className="py-4 px-8">
                    <h1 className="hover:cursor-pointer mt-2 text-gray-900 font-bold text-2xl tracking-tight">Muhammad Usman
                    </h1>
                    <p className="hover:cursor-pointer py-3 text-gray-600 leading-6">I am Software Engineer at Arbisoft
                    </p>
                </div>
                {/* <!-- controls --> */}
