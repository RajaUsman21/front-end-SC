        ...
        {/* ref={sectionRef} */}
            <div className="text-center bg-white p-20">
                ...
                <div className="mt-5 text-center flex justify-center items-center relative">
                    ...
                    <button className='absolute inset-y-1 right-2 hidden md:block ml-2 px-4 py-2 bg-blue-500 text-white rounded-3xl cursor-pointer hover:bg-indigo-200 hover:text-black'>
